...
class Macros extends FormBuilder
{
    ...
    public function selectproductbrand($name, $selected = null, $options = array())
    {
        $list = [
            "" => "Product Brand...",
            "Apple" => "Apple",
    ...
    public function Apple($name, $selected = null, $options = array())
    {
        $list = [
            "" => "Apple Product...",
            "Iphone 11 128GB" => "Iphone 11 128GB",
            "Iphone 11 256GB" => "Iphone 11 256GB",
